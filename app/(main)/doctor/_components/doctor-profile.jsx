...
import { AlertCircle, Badge, Calendar, Clock, FileText, Medal } from 'lucide-react'
...
const DoctorProfile = ({ doctor, availableDays }) => {
   ...
   const toggleBooking = () => {
    ...
    const totalSlots = availableDays.redice((total,day)=>total+day.slots.length,0)
  return (
    ...
    <div className="flex flex-col items-center text-center">
        ...
        <div className="flex items-centre justify-center mb-2">
            <Medal className="h-4 w-4 text-emerald-400 mr-2" />
            <span className="text-muted-foreground">
                {doctor.experience} years experience
            </span>
        </div>
        <Button className="w-fill bg-emerald-600 hover:bg-emerald-700 mt-4">
            Book Appointment
        </Button>
    </div>
                </CardContent>
  ...
  <CardContent>
    ...
    <div className="text-center py-6">
        ...
        <p className="text-muted-foreground">
        This doctor doesnot have any available appointment slots for the next 4 days. Please check back later or try another doctor.
        </p>
    </div>
)}
  </CardContent>
